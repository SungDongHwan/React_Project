...
const Taccident1 = () => {
    const apiData = {
      ...
      // 자바스크립트 object는 키와 값으로 분리가 가능 =>배열 
      ...
      c1 = new Set(c1);
      console.log("대분류 2단계 중복제거",c1)
      c1 = [...c1];
      console.log("대분류 3단계 set을 array로 변경",c1)
      ...
      // 이러면 같은 key를 가진 값들이 마지막것만 들어오기떄문에 다 날라가버린다.
      // 숙제: 이걸 그럼 중분류 key값을 가지고 대분류들이 모두 배열에 넣을수 있께 만들기.
      // [기타]:['횡단중','차도통행중','길가장자리구역통행중','보도통행중']
